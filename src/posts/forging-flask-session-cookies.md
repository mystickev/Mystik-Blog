---
title: Forging Flask Session Cookies
tag: Forensics
date: 2023-03-31
readTime: 5 min
excerpt: A walkthrough on how Flask session cookies can be decoded, bruteforced, and resigned using **flask_unsign** to manipulate authentication values and escalate privileges within a Flask web application.
mitre: N/A
---

![Cracking Flask Cookies](/images/CRACKING.png)
...
![Basic Web App](/images/basic-website.png)
...
![JWT Decoding Flask Cookie](/images/flask-cookie-jwt.png)
...
![Decoding Flask Cookie](/images/flask-unsign-decode.png)
...
But, If we proceed to signing the key, without the secret used to sign, the application will deem the cookie as invalid and slurp us with another 500 error.
...
![Bruteforced Signing Secret](/images/flas-secret.png)
