---
title: AspireCTF: Kernel Padding
tag: CTF
date: 2021-11-10
readTime: 5 min
excerpt: The target for this forensic analysis is a firmware dumped from a camera. Our goal in this challenge being to dump the kernel image and determine the start of padding at the end of the kernel.
mitre: N/A
---
