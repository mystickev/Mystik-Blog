  ...
  return (
    <div className="mystik-container" style={S.container}>
      <div className="section-header" style={S.sectionHeader}>
        <div className="section-title" style={S.sectionTitle}>About</div>
        <div style={{ fontFamily: FONTS.mono, fontSize: 11, color: COLORS.textMuted }}>Mystik</div>
      </div>

      {/* Two-column grid — collapses to single on mobile via CSS */}
          ...
          <div style={S.card}>
            ...
            {[
              ...
              <div key={item.label} className="profile-row">
                ...
                <span style={{ color: COLORS.text, textAlign: 'right', maxWidth: '60%' }}>{item.value}</span>
              </div>
            ))}
          </div>
        </div>
