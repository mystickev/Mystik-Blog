  ...
  return (
    <div className="mystik-container" style={S.container}>
      ...
      <div
        ...
        style={{ padding: '80px 0 64px', borderBottom: `1px solid ${COLORS.border}`, position: 'relative', overflow: 'hidden' }}
      >
        {/* Glow blob */}
        ...
        {/* Eyebrow */}
        <div style={{ fontFamily: FONTS.mono, fontSize: 11, color: COLORS.accent, letterSpacing: '0.18em', textTransform: 'uppercase', marginBottom: 20 }}>
          Threat Research | Malware Analysis | Malware Development
        </div>

        {/* Headline */}
        <h1 style={{ fontFamily: FONTS.display, fontSize: 'clamp(32px, 5.5vw, 66px)', fontWeight: 700, lineHeight: 1.08, letterSpacing: -1.5, marginBottom: 20, maxWidth: 640 }}>
          Where{' '}
          <em style={{ fontStyle: 'italic', color: COLORS.accent }}>offensive techniques</em>
          {' '}meet{' '}
          <em style={{ fontStyle: 'italic', color: COLORS.accent }}>defensive logic.</em>
        </h1>
        ...
        <div className="hero-stats">
          {[
            ...
            <div key={s.label}>
              <div className="hero-stat-num" style={{ fontFamily: FONTS.display, fontSize: 28, fontWeight: 600, letterSpacing: -0.5 }}>{s.num}</div>
      ...
      <div className="section-header" style={S.sectionHeader}>
        <div className="section-title" style={S.sectionTitle}>Recent Write-ups</div>
        <div style={{ fontFamily: FONTS.mono, fontSize: 11, color: COLORS.accent, cursor: 'pointer' }} onClick={onViewAll}>
          view all {'→'}
        </div>
      </div>
